const wow = new WOW({
    ...
    offset: 20, /* по-умолчанию установлено значение 0, то есть как только при прокрутке страницы, элемент достигает низа окна браузера проигрываться анимация, а в данном случае анимация начнется на 20px выше от низа окна браузера */
